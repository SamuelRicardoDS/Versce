        ...
        lg:mt-80 lg:p-5">
            ...
            <div className="flex flex-row mt-10 justify-center">
                ...
                <div className="ml-5 bg-secondary-secondaryBlack rounded-2xl p-4 mt-48">
                    ...
                    <h2 className="font-medium text-xl mt-3">Criação de identidade visual</h2>
                    <p className="font-extralight ml-5">Desenvolvimento de logomarca</p>
                    <p className="font-extralight ml-5">fernando</p>
                    <p className="font-extralight ml-5">fernando</p>
                    <h2 className="font-medium text-xl mt-3">Criação de conteúdo</h2>
                    <p className="font-extralight ml-5">Publicações estratégicas</p>
                    <p className="font-extralight ml-5">fernando</p>
                    <p className="font-extralight ml-5">fernando</p>
                    <h2 className="font-medium text-xl mt-3">Criação de estratégias</h2>
                    <p className="font-extralight ml-5">fernando</p>
                    <p className="font-extralight ml-5">fernando</p>
                    <p className="font-extralight ml-5">fernando</p>
                </div>
